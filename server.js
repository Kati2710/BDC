...
== PROGRAMAS SOCIAIS ==
_bolsafamilia_pagamentos (1.38 bilhão — dados ATÉ 2021): "MÊS COMPETÊNCIA" (BIGINT YYYYMM), "MÊS REFERÊNCIA", UF, "CÓDIGO MUNICÍPIO SIAFI", "NOME MUNICÍPIO", "CPF FAVORECIDO", "NIS FAVORECIDO", "NOME FAVORECIDO", "VALOR PARCELA"
_bolsafamilia_saques (478M — dados ATÉ 2021): "MÊS COMPETÊNCIA" (BIGINT YYYYMM), "MÊS REFERÊNCIA", UF, "CÓDIGO MUNICÍPIO SIAFI", "NOME MUNICÍPIO", "CPF FAVORECIDO", "NIS FAVORECIDO", "NOME FAVORECIDO", "VALOR PARCELA"
_novobolsafamilia (668M — dados 2022 a 2025, Bolsa Família renomeado): "MÊS COMPETÊNCIA" (BIGINT YYYYMM), "MÊS REFERÊNCIA", UF, "CÓDIGO MUNICÍPIO SIAFI", "NOME MUNICÍPIO", "CPF FAVORECIDO", "NIS FAVORECIDO", "NOME FAVORECIDO", "VALOR PARCELA"
ATENÇÃO: Para Bolsa Família 2022-2025 use _novobolsafamilia. Para 2004-2021 use _bolsafamilia_pagamentos. Para histórico completo use UNION ALL das duas.
